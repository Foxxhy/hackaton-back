...
import { serviceMistral } from "../services/llm/mistral.js";
...
export const testMistral = async (req, res) => {
  try {
    const prompt = "Hello how are you?";

    // Appel de ton service Mistral
    const report = await serviceMistral(prompt);
